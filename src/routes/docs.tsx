...
const docSections: DocSection[] = [
  ...
  },
  {
    ...
    technicalDetails: [
      ...
      "Markdown list items matching current approvals or tasks, or explicit markers such as approval:team-approval-1 and task:team-task-1, mount inline workflow buttons in the chat response.",
    ],
  },
  {
    id: "realtime-sync",
  ...
  },
  {
    ...
    technicalDetails: [
      ...
      "Inline approval and task buttons rendered inside chat call the same toggleApprovalStatus and toggleTaskStatus mutations as the table and detail-panel controls.",
      "ArtifactRenderer recognizes pendingApprovals, approvals, assignedTasks, and tasks JSON arrays when assistant output should become interactive action rows.",
