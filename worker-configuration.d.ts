/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e0b6d454fe5b924bbd201b698c86f5ed)
...
interface __BaseEnv_Env {
	...
	ai_command_center_artifacts: R2Bucket;
	DB: D1Database;
	VECTORIZE: VectorizeIndex;
	EMAIL: SendEmail;
	DOCUMENT_INGESTION_QUEUE: Queue;
	GRAPH_WEBHOOK_QUEUE: Queue;
	ASANA_SYNC_QUEUE: Queue;
	...
	CHAT_SYNC: DurableObjectNamespace<import("./dist/server/index").ChatSyncRealtimeDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/server/index");
		durableNamespaces: "ChatSyncRealtimeDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_AI_GATEWAY_ID" | "BRIEFING_REPORTING_WINDOW_HOURS" | "ASANA_WEBHOOK_ORIGIN" | "TAVILY_API_KEY" | "FIRECRAWL_API_KEY" | "ASANA_CLIENT_ID" | "ASANA_CLIENT_SECRET" | "TOKEN_VAULT_KEY" | "ASANA_USE_FULL_PERMISSIONS">> {}
}
